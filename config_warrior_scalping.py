...
Last updated: 2025-11-05 07:03:37
"""
...
BROKER_TYPE = "TRADIER"  # Use Interactive Brokers

# Market data source: "IBKR" or "YAHOO" (for IBKR broker only)
MARKET_DATA_SOURCE = "IBKR"  # Use IBKR for live market data
...
TOTAL_CAPITAL = 1000.0  # $800

# Reserve cash percentage (kept aside, not used for trading)
RESERVE_CASH_PCT = 10.0  # 10.0% = $80 reserved

# Maximum capital utilization (% of usable capital that can be deployed)
MAX_CAPITAL_UTILIZATION_PCT = 90.0  # Max 90.0% of usable capital in positions
...
# ==============================================================================
# PREMARKET TRADING (For Warrior Scalping Gap & Go Strategy)
# ==============================================================================

# Enable premarket scanning (7:00 AM - 10:00 AM for gap detection)
ENABLE_PREMARKET = True  # REQUIRED for Warrior Scalping to work before market open

# Premarket start time (when to begin scanning for gappers)
...
# Test Mode (bypasses trading window checks for testing)
TEST_MODE = False
