"""
Configuration for Background Auto-Trader - TRADIER VERSION
Customize your trading bot settings here
Last updated: 2025-11-03 12:18:02

This is the Tradier-specific version of config_background_trader.py
Automatically loaded when DEFAULT_BROKER=TRADIER is set
"""
...
BROKER_TYPE = "TRADIER"  # Tradier broker (this file is for Tradier)

# Market Data Source (for IBKR only)
# "IBKR" - Use IBKR's data (may be delayed in paper trading without subscriptions)
# "YFINANCE" - Use yfinance for real-time data (free, good for paper trading)
# "HYBRID" - Try IBKR first, fallback to yfinance if delayed (recommended for paper)
MARKET_DATA_SOURCE = "HYBRID"  # Not used for Tradier, but kept for compatibility
...
RESERVE_CASH_PCT = 10.0  # 10.0% = $1,000 reserved

# Maximum capital utilization (% of usable capital that can be deployed)
MAX_CAPITAL_UTILIZATION_PCT = 80.0  # Max 80.0% of usable capital in positions
...
MIN_ENSEMBLE_SCORE = 70  # Only trades passing all 3 systems with 70%+ score

# Minimum AI validation confidence (0-1.0)
MIN_AI_VALIDATION_CONFIDENCE = 0.5  # AI must be 50%+ confident to approve (balanced)
...
TRADING_END_HOUR = 16     # 4:00 PM ET (market close)
TRADING_END_MINUTE = 0

# Extended hours trading (optional)
ENABLE_PREMARKET = False   # Enable pre-market trading (4:00 AM - 9:30 AM ET)
ENABLE_AFTERHOURS = False  # Enable after-hours trading (4:00 PM - 8:00 PM ET)
