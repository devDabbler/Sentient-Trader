...
Last updated: 2025-11-11 08:22:23
"""
...
RESERVE_CASH_PCT = 0.1  # 0.1% = $1 reserved
...
RISK_PER_TRADE_PCT = 0.03  # 3.0% risk per trade
MAX_DAILY_LOSS_PCT = 0.06  # 6.0% max daily loss
...
WATCHLIST = ['AFRM', 'AMC', 'AMD', 'AMTD', 'ARBK', 'BB', 'BTBT', 'CHPT', 'COP', 'CVU', 'ENPH', 'EVGO', 'FCEL', 'GOGY', 'HKD', 'MAIA', 'MARA', 'NOK', 'OXY', 'PINS', 'PLTR', 'PLUG', 'RIOT', 'RIVN', 'RUN', 'SGMO', 'SI', 'SOFI', 'SRFM', 'TLRY', 'UROY', 'VXRT', 'WFC', 'WKHS']
