...
class AlertCategory(Enum):
    ...
    DEX_FAST_MONITOR = "DEX_FAST_MONITOR"   # DEX fast position monitor
    PUMPFUN_ALERTS = "PUMPFUN_ALERTS"       # pump.fun bonding curve alerts (gambling channel)
...
WEBHOOK_ENV_VARS = {
    ...
    AlertCategory.DEX_FAST_MONITOR: "DISCORD_WEBHOOK_DEX_FAST_MONITOR",
    AlertCategory.PUMPFUN_ALERTS: "DISCORD_WEBHOOK_PUMPFUN_ALERTS",
...
CHANNEL_ID_ENV_VARS = {
    ...
    AlertCategory.DEX_FAST_MONITOR: "DISCORD_CHANNEL_ID_DEX_FAST_MONITOR",
    AlertCategory.PUMPFUN_ALERTS: "DISCORD_CHANNEL_ID_PUMPFUN_ALERTS",
