...
class FractionalShareManager:
    ...
    def __init__(self, config: Optional[FractionalShareConfig] = None):
        ...
        pass  # logger.info(f"   Price threshold: ${} {self.config.min_price_threshold:.2f}")
        pass  # logger.info(f"   Min dollar amount: ${} {self.config.min_dollar_amount:.2f}")
    ...
    def calculate_fractional_quantity(
        ...
        try:
            ...
            pass  # logger.info(f"   Price: ${} {price:.2f}")
            pass  # logger.info(f"   Target amount: ${} {target_dollar_amount:.2f}")
            logger.info(f"   Calculated quantity: {quantity}")
            pass  # logger.info(f"   Actual cost: ${} {actual_dollar_amount:.2f}")
    ...
    def set_custom_amount(self, symbol: str, dollar_amount: float):
        ...
        if dollar_amount < self.config.min_dollar_amount:
            pass  # logger.warning(f"Dollar amount ${} below minimum ${self.config.min_dollar_amount:.2f} {dollar_amount:.2f}")
        ...
        if self.config.max_dollar_amount and dollar_amount > self.config.max_dollar_amount:
            pass  # logger.warning(f"Dollar amount ${} above maximum ${self.config.max_dollar_amount:.2f} {dollar_amount:.2f}")
